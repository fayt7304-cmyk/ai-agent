...
The latest deployment includes full implementation of previously missing features:
...
- **Enhanced Settings** — Full control over voice (language, style, speed), animations (none/reduced/normal), and typography (font family and size).
...
- **Voice Engine**: Configure language (8+ supported), style (Friendly, Formal, etc.), and speed.

- **Accessibility**: Motion controls for `prefers-reduced-motion` and customizable typography.
